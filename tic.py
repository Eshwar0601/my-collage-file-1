...
while True:
    ...
    elif(board[1]=='x' and board[2]== 'x' and board[3]=='x' or board[4]=='x' and board[5]== 'x' and board[6]=='x'     or board[7]=='x' and board[8]== 'x' and board[9]=='x'or board[1]=='x' and board[4]== 'x' and board[7]=='x'or board[2]=='x' and board[5]== 'x' and board[8]=='x'        or board[3]=='x' and board[6]== 'x' and board[9]=='x'    or board[1]=='x' and board[5]== 'x' and board[9]=='x'   or board[3]=='x' and board[5]== 'x' and board[7]=='x'):
        print_borad()
        print("x wins!!!")
        break
